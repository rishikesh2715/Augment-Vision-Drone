...
def drawTriangle(pilot, direction, resized_frame, drone, q):
...
def display_heading(pilot, drone, q, objectDistance, offsetAngle):
    try:
            ...
            if direction is not None:
                ...
                if angle_limit_left <= angle_limit_right:
                    if angle_limit_left <= direction <= angle_limit_right:
                        drawTriangle(pilot, direction, resized_frame, drone, q)
