# Data provider for the Drone implementation
...
def sendToMCT(run):
    ...
    UDP_PORT_SEND =50020   #chosen port to OpenMCT (same as in telemetry server object)
...
def command(run):
    ...
    UDP_PORT_RCV =50021    #chosen port to OpenMCT (same as in telemetry server object)
    data = ''
    addr = ''
    connected = False
