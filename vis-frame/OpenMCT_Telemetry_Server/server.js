...
var realtimeServerDrone = new RealtimeServer(drone);
var historyServerDrone = new HistoryServer(drone);
...
app.use('/DroneRealtime', realtimeServerDrone);
app.use('/DroneHistory', historyServerDrone);
